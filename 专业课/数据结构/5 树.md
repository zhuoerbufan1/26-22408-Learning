...
### 5.1.1 和 5.1.2 树的定义和基本术语

![image.png](https://typora-1310242472.cos.ap-nanjing.myqcloud.com/typora_img/20250503144101.png)


### 5.1.3 树的性质

![image.png](https://typora-1310242472.cos.ap-nanjing.myqcloud.com/typora_img/20250503144521.png)
...
![image.png](https://typora-1310242472.cos.ap-nanjing.myqcloud.com/typora_img/20250503150824.png)
...
叶子结点规律？
度为 1 的结点规律？
结点编号的规律，结点 i 的左孩子，右孩子，父节点的编号分别是什么？

==完全二叉树==

叶子结点规律？
度为 1 结点规律？
结点编号规律？完全二叉树叶子结点和分支结点的编号规律？
...
n 个结点的完全二叉树的高度 h的两种推导？一种以满二叉树一层最后一个结点做参考，一种以满二叉树一层第一个结点做参考

两种推导方式h 和 n 满足的不等式关系是什么？

完全二叉树的度为 1 的结点个数的特点；

 完全二叉树 n 0 + n 2 的特点？
 
完全二叉树根据结点个数 n 计算 n 1, n 0, n 2 怎么计算？
...
完全二叉树的顺序存储如何根据结点 i 判断其是否有左孩子，右孩子？如果判断 i 是否是叶结点？

非完全二叉树的顺序存储如何根据结点 i 判断其是否有左孩子，右孩子？如果判断 i 是否是叶结点？
