...
![image.png](https://typora-1310242472.cos.ap-nanjing.myqcloud.com/typora_img/20250930171929.png)


对于一个顶点 A 来说，它会对应一个头结点在 AdjList【】这个数组中

这个头结点引出的一条链表，这个链表存放了 A 连接的所有的边结点
...
对于一条边来说，比如 A-B，他会分别对应两个边结点存放在 A 和 B 两个头结点引出的链表中

所以|E|条边就会对应 2|E|条边结点，同时对应|V|个顶点对应的头结点
### 无向图的邻接表存储中，边结点个数与实际边的个数的关系

实际边的个数是|E|个，每个边会对应两个边结点，比如 A-B，对应两个边结点，分别在 A 和 B 头结点引出的两个链表中
...
![image.png](https://typora-1310242472.cos.ap-nanjing.myqcloud.com/typora_img/20250928174249.png)

![image.png](https://typora-1310242472.cos.ap-nanjing.myqcloud.com/typora_img/20250928174317.png)
